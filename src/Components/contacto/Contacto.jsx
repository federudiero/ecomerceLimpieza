    ...
    return (
        <div className="flex flex-col md:flex-row justify-center items-center bg-gray-300 min-h-screen">
            <div className="md:w-1/2 p-8 bg-black ">
                <h2 className="text-3xl font-bold mb-6 text-gray-800">Contactanos</h2>
                ...
                <textarea className="w-full bg-white px-4 py-2 mb-4 border border-gray-300 rounded-md resize-none" id="mensaje" value={mensajeUsuario} onChange={(e) => setMensajeUsuario(e.target.value)}></textarea>

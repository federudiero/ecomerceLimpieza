...
function Card({ id, nombre, category, precio, url }) {
  ...
  return (
    <div className="w-48 rounded overflow-hidden shadow-lg bg-white flex flex-col justify-between transform transition duration-300 hover:shadow-2xl hover:scale-105">
